    ...
    <>
      <div className="about-container">
        <h1 className="about-title">
          МЫ <span style={{ color: "#dc2626" }}>VINCERE MORTEM</span>
        </h1>
        <p className="about-text">
          Основанная в 2025 году, VINCERE MORTEM стала доминирующей силой в мировом киберспорте. Наша миссия — не просто побеждать, а завоевывать сердца игроков.
        </p>
      </div>
      ...
      <div className="about-philosophy-container">
        <h2 className="about-philosophy-title">НАША ФИЛОСОФИЯ</h2>

        <div className="about-philosophy-content">
          <p>
            Vincere Mortem — это не просто киберспортивная организация.
            ...
            Наша философия строится на трёх принципах:
          </p>

          <h3>Структура</h3>
          <p>
            Мы создаём среду, в которой каждый игрок, тренер и участник команды понимает свою роль.
            Чёткие процессы, дисциплина и организация — основа стабильного результата.
          </p>

          <h3>Развитие</h3>
          <p>
            Мы работаем не только с текущим уровнем игроков, но и с их потенциалом.
            Наша задача — не просто выигрывать сегодня, а формировать составы, способные конкурировать на международной сцене в долгосрочной перспективе.
          </p>

          <h3>Ответственность</h3>
          <p>
            Каждый участник Vincere Mortem несёт ответственность за результат — перед командой, организацией и аудиторией.
            Мы ценим профессиональный подход, уважение и умение держать уровень вне зависимости от обстоятельств.
          </p>
          ...
          <p>
            Vincere Mortem — это путь. Путь от потенциала к результату.
          </p>
        </div>
