  ...
  return (
    <>
      ...
      <div className="about-philosophy-container">
        ...
        <h3 className="about-team-item-title">Структура</h3>
        <p className="about-text">Мы создаём среду, в которой каждый игрок, тренер и участник команды понимает свою роль.
          Чёткие процессы, дисциплина и организация — основа стабильного результата.<br /><br /></p>
        <h3 className="about-team-item-title">Развитие</h3>
        <p className="about-text">Мы работаем не только с текущим уровнем игроков, но и с их потенциалом.
        ...
        <h3 className="about-team-item-title">Ответственность</h3>
        <p className="about-text">Каждый участник Vincere Mortem несёт ответственность за результат — перед командой, организацией и аудиторией.
