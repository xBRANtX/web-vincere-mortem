    ...
    <>
      ...
      <div className="about-philosophy-container">
        ...
        <p className="about-text">Vincere Mortem — это не просто киберспортивная организация.
          ...
          Наша философия строится на трёх принципах: <br /><br /></p>
        <h3 className="about-team-item-structure">Структура</h3>
        <p className="about-text-structura">Мы создаём среду, в которой каждый игрок, тренер и участник команды понимает свою роль.
          Чёткие процессы, дисциплина и организация — основа стабильного результата.<br /><br /></p>
        <h3 className="about-team-item-development">Развитие</h3>
        <p className="about-text-development">Мы работаем не только с текущим уровнем игроков, но и с их потенциалом.
          Наша задача — не просто выигрывать сегодня, а формировать составы, способные конкурировать на международной сцене в долгосрочной перспективе.<br /><br /></p>
        <h3 className="about-team-item-responsibility">Ответственность</h3>
        <p className="about-text-responsibility">Каждый участник Vincere Mortem несёт ответственность за результат — перед командой, организацией и аудиторией.
          ...
          турниры, медийные форматы, аналитические инструменты и платформы для роста игроков.<br /><br />
