    ...
    <>
      ...
      <div className="about-philosophy-container">
        ...
        <p className="about-text">Vincere Mortem — это не просто киберспортивная организация.
          Это система, построенная вокруг идеи постоянного роста, дисциплины и ответственности за результат.<br /><br /><br /><br />

          Мы верим, что победа — это не случайность и не вспышка формы.
          Это результат структуры, ежедневной работы и правильного окружения.<br /><br /><br /><br />

          Наша философия строится на трёх принципах:<br /><br /><br /><br />

          Структура<br /><br /><br /><br />
          Мы создаём среду, в которой каждый игрок, тренер и участник команды понимает свою роль.
          Чёткие процессы, дисциплина и организация — основа стабильного результата.<br /><br /><br /><br />

          Развитие<br /><br /><br /><br />
          Мы работаем не только с текущим уровнем игроков, но и с их потенциалом.
          Наша задача — не просто выигрывать сегодня, а формировать составы, способные конкурировать на международной сцене в долгосрочной перспективе.<br /><br /><br /><br />

          Ответственность<br /><br /><br /><br />
          Каждый участник Vincere Mortem несёт ответственность за результат — перед командой, организацией и аудиторией.
          Мы ценим профессиональный подход, уважение и умение держать уровень вне зависимости от обстоятельств.<br /><br /><br /><br />

          Мы развиваем не только составы, но и экосистему вокруг них:
          турниры, медийные форматы, аналитические инструменты и платформы для роста игроков.<br /><br /><br /><br />
